...
class LSM6DS0
{
	public:
		...
		int16_t acc_getAxesYRaw(void);
		int16_t acc_getAxesZRaw(void);
		int16_t acc_getAxesX(void);
		int16_t acc_getAxesY(void);
		int16_t acc_getAxesZ(void);
		int16_t gyro_getAxesXRaw(void);
		int16_t gyro_getAxesYRaw(void);
		int16_t gyro_getAxesZRaw(void);
		int16_t gyro_getAxesX(void);
		int16_t gyro_getAxesY(void);
